...
public static class DependencyInjection
{
    ...
    public static WebApplicationBuilder AddApplicationServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services
            .AddHttpClient("github")// configures http client for calling the github api
        ...
        builder.Services.Configure<EncryptionOptions>(builder.Configuration.GetSection("Encryption"));// values of the section will be mapped to this obj
    ...
    public static WebApplicationBuilder AddBackgroundJobs(this WebApplicationBuilder builder)
    {
        ...
        // for starting the Quartz scheduler
        // without this jobs and triggers won't work
